...
def load_data(dir, config):
    ...
    #data_frame = filter2(data_frame, config)
    ...
    if translation == "english":
        ...
        save_dataset(data_frame['premise_en'], data_frame['hypothesis_en'], data_frame['label'], f"train_{translation}.txt")
        save_dataset(data_frame_dev['premise_en'], data_frame_dev['hypothesis_en'], data_frame_dev['label'], f"dev_{translation}.txt")
        print(data_frame.groupby("label").count())
        return data_frame['premise_en'], data_frame['hypothesis_en'], data_frame['label'], data_frame_dev['premise_en'], data_frame_dev['hypothesis_en'], data_frame_dev['label']
